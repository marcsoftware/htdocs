<?php
  ...
  */
  ...
  $sql = "SELECT COUNT(isDone) as total from manager where $condition AND customer_name='$customer_name'";
echo $sql;
  ...
  $sql = "SELECT COUNT(isDone) as total from manager where isDone=1 AND $condition AND customer_name='$customer_name'";
