...
<script type='text/javascript'>
    ...
    function gotoCalendarPage(date,color){
        ...
        var page ="/Dropbox/pure_code/modes/de_selftest.php?fileName=getCalendarWords.php&folder=../pure_code/material/js-ref&mode=de_selftest.php&cleanup=0&block=4";
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    function gotoFocusStudyPage(all=false){
        ...
        //go to a new web page
        var page ="/Dropbox/pure_code/modes/de_selftest.php?fileName=getFilterdWords.php&folder=../pure_code/material/js-ref&mode=de_selftest.php&cleanup=0&block=4";
