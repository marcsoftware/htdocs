<?php
    ...
    */
    ...
    $sql = "DELETE FROM todo2 WHERE project='' and  body=''";
    $conn->query($sql);

    $sql = "SELECT * from todo2 where $condition AND $secondCondition AND customer_name='$customer_name' order by date DESC ";
