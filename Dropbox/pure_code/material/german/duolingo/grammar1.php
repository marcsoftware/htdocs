...
<div class="row d-block">
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='1'>1 Welcome to German :)</h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='2'>2 Capitalizing nouns</h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='3'>3 German genders are strange</h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='4'>4 Verb conjugations</h3>
    <div>
    </div>
    <h4 class="p-2 mt-5 mb-2 bg-info text-white" id='5'>5 Conjugating regular verbs</h4>
    <div>
        <p>
    ...
    <h4 class="p-2 mt-5 mb-2 bg-info text-white" id='6'>6 Conjugations of the verb <em>sein</em> (to be)</h4>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='7'>7 Umlauts</h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='8'>8 No continuous aspect</h3>
    <div>
        <p>
...
<div class="row d-block">
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='9'>9 Definite articles</h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='10'>10 Conjugating verbs</h3>
    <div>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='11'>11 Generic vs. specific (German is not Spanish or French)</h3>
    <div>
        <p>
...
<div class="row d-block">
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='12'>12 German plurals are also strange :)</h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='13'>13 You, you and you</h3>
    <div>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='14'>14 <em>Ihr</em> vs. <em>er</em></h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='15'>15 Verb conjugation</h3>
    <div>
...
<div class="row d-block">
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='16'>16 Common phrases</h3>
    <div>
        <p>
    ...
    <h4 class="p-2 mt-5 mb-2 bg-info text-white" id='17'>17 <em>Wie geht's?</em></h4>
    <div>
        <p>
    ...
    <h4 class="p-2 mt-5 mb-2 bg-info text-white" id='18'>18 <em>Willkommen</em> can be a false friend</h4>
    <div>
        <p>
    ...
    <h4 class="p-2 mt-5 mb-2 bg-info text-white" id='19'>19 <em>Entschuldigung!</em></h4>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='20'>20 Duo</h3>
    <div>
        <p>
...
<div class="row d-block">
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='21'>21 German Cases</h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='22'>22 Flexible sentence order</h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='23'>23 Vowel change in some verbs</h3>
    <div>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='24'>24 <em>Isst</em> vs. <em>ist</em></h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='25'>25 <em>Ich habe Brot</em></h3>
    <div>
        <p>
...
<div class="row d-block">
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='26'>26 Grammar break!</h3>
    <div>
        <p>
    ...
    <h4 class="p-2 mt-5 mb-2 bg-info text-white" id='27'>27 Harness the power of other learners</h4>
    <div>
        <p>
...
<div class="row d-block">
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='28'>28 <em>Ich habe Hunger!</em></h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='29'>29 Compound words</h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='30'>30<em>Mittagessen</em> — lunch or dinner?</h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='31'>31 Cute like sugar!</h3>
    <div>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='32'>32 Does <em>Gemüse</em> mean "vegetable" or "vegetables"?</h3>
    <div>
        <p>
...
<div class="row d-block">
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='33'>33 Recognizing noun gender</h3>
    <div>
        <p>
    ...
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='34'>34 <em>Fressen</em> vs. <em>essen</em></h3>
    <div>
        <p>
