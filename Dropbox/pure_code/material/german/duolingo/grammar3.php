...
<div class="row d-block">
    <h3 class="p-2 mt-5 mb-2 bg-info text-white" id='1'>1 Personal Pronouns in the Nominative Case</h3>
    <div>
        <p>
    ...
    <h4 class="p-2 mt-5 mb-2 bg-info text-white" id='2'>2 Possessive pronouns</h4>
    <div>
        <p>
