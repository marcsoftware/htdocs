...
function NewQuiz (text,handle) {
    ...
    this.create = function(id) {
        ...
        console.log('this.score always starts at   '+(this.score=0));
...
function playSound() {
  ...
  function compare(x,y){
    ...
    this.check = function( input) {
      ...
      if(found>=0){
        document.getElementById('missed').innerHTML=this.codes[this.score]; //show last correct answere
        this.correctAns();
    ...
    this.gaveup = function(){
        ...
        //this.codes.push(this.codes[this.score]);
        this.maxScore=this.codes.length;
        document.getElementById('missed').innerHTML=this.codes[this.score];
      ...
      var thisline='';
       ...
       skipped = 0;
        ...
        do{
            ...
            thisline = (this.codes[this.score]);
       ...
       for(var i=0;result.length<Quiz.BLOCK ;i++){
          var randomNumber = Math.floor(Math.random() * this.maxScore);
          
          
            
            
            thisline = (this.codes[randomNumber]);
            thisline= thisline.replace(/\t+/g,' ≈ ');
            result.push(thisline);
