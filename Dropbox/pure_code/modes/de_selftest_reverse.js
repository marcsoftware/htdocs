...
//---------------------------------------------------------------------
*/
var modeName='de_selfttest_reverse.php'
...
//---------------------------------------------------------------------
*/
function flipArray(list){   
 list=   list.map(flipElement);
 return list;
}
...
//---------------------------------------------------------------------
*/
function flipElement(value){
  value = value.split('\t');
            new_value =  value[1]+' \t'+value[0];
