...
function makeQuiz(){
    ...
    for(var i=0;i<quizes.length;i++){
        ...
        quizes[i].create(i); //TODO fix this design flaw: this line is why it is not inherited from libary-3.js and we have to copy that function into this file
        //quizes[i].makeEvents();
